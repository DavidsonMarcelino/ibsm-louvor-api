...
Route::group([
    ...
    Route::group([
        ...
        */
        ...
        /*
        |--------------------------------------------------------------------------
        | UsuarioInstrumento Routes
        |--------------------------------------------------------------------------
        */
        Route::resource('usuarioinstrumentos', 'UsuarioInstrumentoController');
        ...
        */
        ...
        Route::get('calendario', 'EscalaController@calendario');
        ...
        */
        ...
        |--------------------------------------------------------------------------
        */
        Route::resource('partituras', 'PartituraController');
